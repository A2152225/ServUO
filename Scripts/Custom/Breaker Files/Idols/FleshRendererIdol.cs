...
{ 
   public class FleshRendererIdol : Item 
   { 
      [Constructable] 
      public FleshRendererIdol() : base( 9775 ) 
      { 
         Movable = true; 
         Name = "Flesh Renderer Costume";  
         LootType = LootType.Blessed; 
      } 

      public FleshRendererIdol( Serial serial ) : base( serial ) 
      { 
      } 
