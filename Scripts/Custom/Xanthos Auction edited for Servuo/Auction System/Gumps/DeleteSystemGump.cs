...
namespace Arya.Auction
{
	...
	public class DeleteAuctionGump : Gump
	{
		...
		private void MakeGump()
		{
			...
			AddLabel(70, 15, AuctionLabelHue.kRedHue, AuctionSystem.ST[ 96 ] );
			AddHtml( 30, 45, 285, 130, AuctionSystem.ST[ 97 ] , (bool)false, (bool)false);

			// Close: Button 1
			AddButton(30, 185, 4017, 4017, 1, GumpButtonType.Reply, 0);
			AddLabel(70, 185, AuctionLabelHue.kRedHue, AuctionSystem.ST[ 98 ] );
			AddButton(30, 215, 4014, 4015, 0, GumpButtonType.Reply, 0);
			AddLabel(70, 215, AuctionLabelHue.kGreenHue, AuctionSystem.ST[ 99 ] );
		}
