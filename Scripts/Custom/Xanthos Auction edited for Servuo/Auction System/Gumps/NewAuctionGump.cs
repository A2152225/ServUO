...
namespace Arya.Auction
{
	...
	public class NewAuctionGump : Gump
	{
		...
		{			
			...
			AddLabel(250, 10, AuctionLabelHue.kRedHue, AuctionSystem.ST[ 100 ] );

			// Starting bid: text 0
			AddLabel(170, 35, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 68 ] );
			AddImageTiled(254, 34, 72, 22, 2524);
			AddImageTiled(255, 35, 70, 20, 2624);
			AddAlphaRegion(255, 35, 70, 20);
			AddTextEntry(255, 35, 70, 20, AuctionLabelHue.kGreenHue, 0, m_Auction.MinBid.ToString( "#,0" ) );

			// Reserve: text 1
			AddLabel(345, 35, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 69 ] );
			AddImageTiled(414, 34, 72, 22, 2524);
			AddImageTiled(415, 35, 70, 20, 2624);
			AddAlphaRegion(415, 35, 70, 20);
			AddTextEntry(415, 35, 70, 20, AuctionLabelHue.kGreenHue, 1, m_Auction.Reserve.ToString( "#,0" ) );

			// Days duration: text 2
			AddLabel(170, 60, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 101 ] );
			AddImageTiled(254, 59, 32, 22, 2524);
			AddImageTiled(255, 60, 30, 20, 2624);
			AddAlphaRegion(255, 60, 30, 20);
			AddTextEntry(255, 60, 30, 20, AuctionLabelHue.kGreenHue, 2, m_Auction.Duration.TotalDays.ToString() );
			AddLabel(290, 60, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 102 ] );

			// Item name: text 3
			AddLabel(170, 85, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 50 ] );
			AddImageTiled(254, 84, 232, 22, 2524);
			AddImageTiled(255, 85, 230, 20, 2624);
			AddAlphaRegion(255, 85, 230, 20);
			AddTextEntry(255, 85, 230, 20, AuctionLabelHue.kGreenHue, 3, m_Auction.ItemName );

			// Buy now: Check 0, Text 6
			AddCheck( 165, 110, 2152, 2153, false, 0 );
			AddLabel( 200, 115, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 208 ] );
			AddImageTiled( 329, 114, 157, 22, 2524 );
			AddImageTiled( 330, 115, 155, 20, 2624 );
			AddAlphaRegion( 330, 115, 155, 20 );
			AddTextEntry( 330, 115, 155, 20, AuctionLabelHue.kGreenHue, 6, "" );

			// Description: text 4
			AddLabel(170, 140, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 103 ] );
			AddImageTiled(169, 159, 317, 92, 2524);
			AddImageTiled(170, 160, 315, 90, 2624);
			AddAlphaRegion(170, 160, 315, 90);
			AddTextEntry(170, 160, 315, 90, AuctionLabelHue.kGreenHue, 4, m_Auction.Description);

			// Web link: text 5
			AddLabel(170, 255, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 104 ] );
			AddImageTiled(224, 274, 262, 22, 2524);
			AddLabel(170, 275, AuctionLabelHue.kLabelHue, @"http://");
			AddImageTiled(225, 275, 260, 20, 2624);
			AddAlphaRegion(225, 275, 260, 20);
			AddTextEntry(225, 275, 260, 20, AuctionLabelHue.kGreenHue, 5, m_Auction.WebLink );
			...
			AddLabel(210, 300, AuctionLabelHue.kRedHue, AuctionSystem.ST[ 106 ] );
			AddLabel(210, 315, AuctionLabelHue.kRedHue, AuctionSystem.ST[ 107 ] );

			// Cancel button: button 0
			AddButton(170, 335, 4020, 4020, 0, GumpButtonType.Reply, 0);
			AddLabel(210, 335, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 108 ] );
		}
