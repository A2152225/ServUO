...
namespace Arya.Auction
{
	...
	public class MyAuctionGump : Gump
	{
		...
		private void MakeGump()
		{
			...
			AddLabel(100, 130, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 11 ] );
			AddLabel(285, 130, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 12 ] );
			AddLabel(100, 165, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 13 ] );
			...
			AddLabel(100, 205, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 14 ] );
