...
namespace Server.Mobiles
{
	...
	[CorpseName( "an ore elemental corpse" )]
	public class RoyaliteOreElemental : BaseCreature
	{
		[Constructable]
		public RoyaliteOreElemental() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			// TODO: Gas attack
			Name = "a Royalite ore elemental";
			Body = 108;
			BaseSoundID = 268;
			Hue = 1153;
			...
			PackGem();
			//PackMagicItems( 2, 5 );
			PackItem( new RoyaliteOre( 10 ) );
		}

		public override bool AutoDispel{ get{ return true; } }

		public RoyaliteOreElemental( Serial serial ) : base( serial )
		{
		}
	...
	[CorpseName( "an ore elemental corpse" )]
	public class DaniteOreElemental : BaseCreature
	{
		[Constructable]
		public DaniteOreElemental() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			// TODO: Gas attack
			Name = "a Danite ore elemental";
			Body = 108;
			BaseSoundID = 268;
			Hue = 1153;
			...
			PackGem();
			//PackMagicItems( 2, 5 );
			PackItem( new DaniteOre( 10 ) );
		}

		public override bool AutoDispel{ get{ return true; } }

		public DaniteOreElemental( Serial serial ) : base( serial )
		{
		}
