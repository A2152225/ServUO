...
namespace Arya.Chess
{
	public class King : BaseChessPiece
	{
		...
		public King( Chssbrd board, ChessColor color, Point2D position ) : base( board, color, position )
		{
		}
		...
		{
			m_Chessboard.PlaySound( m_Piece, m_CheckSound );
			m_Piece.Say( "*CHECK*" );
		}

		public void PlayCheckMate()
		{
			m_Chessboard.PlaySound( m_Piece, m_CheckMateSound );
