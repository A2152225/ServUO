...
namespace Arya.Chess
{
	...
	public class ChessGame
	{
		...
		/// <summary>
		/// Sets the attack effect on the chessboard
		/// </summary>
		...
		/// <summary>
		/// Sets the capture effect on the chessboard
		/// </summary>
		...
		/// <summary>
		/// Sets the BoltOnDeath property on the chessboard
		/// </summary>
		...
		/// <summary>
		/// Gets the orientation of the chessboard
		/// </summary>
		...
		public void AcceptGame( Mobile guest )
		{
			...
			m_Board = new Chssbrd( m_Black, m_White, m_Z, m_Bounds, this, m_Parent.ChessSet, m_Parent.WhiteHue, m_Parent.BlackHue, m_Parent.WhiteMinorHue, m_Parent.BlackMinorHue );
		...
		private void OnPlayerDisconnected(DisconnectedEventArgs e)
		{
			if ( e.Mobile == m_Black || e.Mobile == m_White )
			{
				...
				else
				{
					...
					if ( m_White != null && m_White.Target != null && m_Black.Target is ChessTarget )
