...
namespace Arya.Chess
{
	...
	/// <summary>
	/// Defines the style of the NPCs on the chessboard
	/// </summary>
	...
	/// <summary>
	/// The orientaion of the game on the chessboard
	/// </summary>
	...
	public class Chssbrd
	{
		...
		/// <summary>
		/// The orientation of the chessboard
		/// </summary>
		...
		public Chssbrd( Mobile black, Mobile white, int z, Rectangle2D bounds, ChessGame game, ChessSet chessSet, int whiteHue, int blackHue, int whiteMinorHue, int blackMinorHue )
		{
			m_Game = game;
			m_Black = black;
			m_White = white;
		...
		/// <summary>
		/// Rebuilds the chessboard applying any changes made to the NPCs
		/// </summary>
		public void Rebuild()
		{
