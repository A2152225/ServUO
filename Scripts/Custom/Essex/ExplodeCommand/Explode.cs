...
namespace Server.Scripts.Commands
{
	public class ExplodeCommand
	{
		...
		{
			CommandSystem.Register( "Explode", AccessLevel.Developer, new CommandEventHandler( Explode_OnCommand ) );
		}
		...
		private class ExplodeTarget : Target
		{
			...
			protected override void OnTarget( Mobile from, object o )
			{
				...
				{		
					...
					{
						Console.WriteLine("Explosion Crash Detected!");
					}
				}
				else
				{
		...
		private static void Explode_OnCommand( CommandEventArgs e )
		{
			...
			e.Mobile.SendMessage( "Please Target Your Victim..." );
		}
	}
}
