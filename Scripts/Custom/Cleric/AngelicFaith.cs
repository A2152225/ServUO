	...
	public class AngelicFaithSpell : ClericSpell
	{
		...
		public override void OnCast()
		{
			...
			else if ( CheckSequence() )
			{
				...
				{
					new StatMod( StatType.Str, "[Cleric] Str Offset", 20+ImperialOrb.IncI( Caster, this ), TimeSpan.Zero ),
					new StatMod( StatType.Dex, "[Cleric] Dex Offset", 20+ImperialOrb.IncI( Caster, this ), TimeSpan.Zero ),
					new StatMod( StatType.Int, "[Cleric] Int Offset", 20+ImperialOrb.IncI( Caster, this ), TimeSpan.Zero ),
					new DefaultSkillMod( SkillName.Macing, true, 20+ImperialOrb.IncI( Caster, this ) ),
					new DefaultSkillMod( SkillName.Healing, true, 20+ImperialOrb.IncI( Caster, this ) ),
					new DefaultSkillMod( SkillName.Anatomy, true, 20+ImperialOrb.IncI( Caster, this ) )
				};
				...
				span += ImperialOrb.IncD( Caster, this );
				...
				//Caster.BodyMod = 123;//can't see them when mounted
