    ...
    public class BOBGump : Gump
    {
        ...
        public bool CheckFilter(BulkMaterialType mat, int amountMax, bool isLarge, bool reqExc, BODType deedType, Type itemType)
        {
            ...
            switch ( f.Material )
            {
				...
				case 29: return (mat == BulkMaterialType.Royalite);
				case 30: return (mat == BulkMaterialType.Danite);
                ...
                case BODType.Smith:
                    {
                        switch ( mat )
                        {
							...
							case BulkMaterialType.Royalite: return "Royalite";
                            case BulkMaterialType.Danite: return "Danite";
