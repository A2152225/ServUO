...
namespace Scripts.Mythik.Systems.Achievements
{
    ...
    public class AchievmentSystem
    {
        ...
        public static void Initialize()
        {
	        ...
	        Achievements.Add(new HunterAchievement(1002, 3000, 0x25D1, false, null, 50, "Allosaurus Slayer", "Slay 50 Allosaurus", 5, typeof(Allosaurus)));
	        Achievements.Add(new HunterAchievement(1003, 3000, 0x25D1, false, null, 50, "Rabbit Slayer", "Slay 50 Rabbits", 5, typeof(Rabbit)));
		...
		//Start counting it all 
	/*	internal static void StartCountingStatus(PlayerMobile player,  BaseAchievement ach, int progress, dynamic mtype)
        {
#if STOREONITEM
           ...
           if (!AchievementSystemMemoryStone.GetInstance().Achievements.ContainsKey(player.Serial))
			...
			//debug
			player.SendMessage("You have now killed a {0} {1}s", achieves[ach.ID].Progress, mtype.Name);
		}
//end pre-emptive store
		*/
