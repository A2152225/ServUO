...
namespace Arya.Auction
{
	...
	public class AuctionControlGump : Gump
	{
		...
		private void MakeGump()
		{
			...
			AddLabel(99, 15, AuctionLabelHue.kGreenHue, AuctionSystem.ST[ 213 ] );
			AddImageTiled(15, 35, 270, 1, 9304);
			AddImageTiled(30, 55, 1, 65, 9304);

			// Auction owner
			bool owner = m_Auction.Owner != null;
			AddLabel(15, 35, AuctionLabelHue.kRedHue, string.Format( AuctionSystem.ST[ 216 ], owner ? m_Auction.Owner.Name : AuctionSystem.ST[ 78 ] ));
			...
			AddLabel(55, 55, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 214 ] );;
			...
			AddLabel(55, 75, AuctionLabelHue.kLabelHue, string.Format( AuctionSystem.ST[ 215 ], ( owner && m_Auction.Owner.Account != null ) ? ( m_Auction.Owner.Account as Server.Accounting.Account ).Username : AuctionSystem.ST[ 78 ] ) );
			...
			AddLabel(55, 95, online ? AuctionLabelHue.kGreenHue : AuctionLabelHue.kRedHue, online ? AuctionSystem.ST[ 217 ] : AuctionSystem.ST[ 218 ] );

			AddImageTiled(15, 120, 270, 1, 9304);
			AddLabel(20, 125, AuctionLabelHue.kRedHue, AuctionSystem.ST[ 219 ]);
			AddImageTiled(30, 145, 1, 65, 9304);

			// Item Properties : 4
			AddButton(35, 150, 9702, 9703, 4, GumpButtonType.Reply, 0);
			AddLabel(55, 147, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 214 ]);

			bool item = m_Auction.Item != null;

			// Get item : 5
			AddButton(35, 170, 9702, 9703, 5, GumpButtonType.Reply, 0);
			AddLabel(55, 167, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 220 ] );
            
			// Return item: 6
			AddButton(35, 190, 9702, 9703, 6, GumpButtonType.Reply, 0);
			AddLabel(55, 187, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 221 ] );

			AddImageTiled(15, 210, 270, 1, 9304);
			AddLabel(20, 215, AuctionLabelHue.kRedHue, AuctionSystem.ST[ 222 ] );
			AddImageTiled(30, 235, 1, 110, 9304);

			// Auction Properties: 7
			AddButton(35, 240, 9702, 9703, 7, GumpButtonType.Reply, 0);
			AddLabel(55, 237, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 214 ] );

			// End auction now: 8
			AddButton(35, 260, 9702, 9703, 8, GumpButtonType.Reply, 0);
			AddLabel(55, 257, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 223 ] );

			// Close and return: 9
			AddButton(35, 280, 9702, 9703, 9, GumpButtonType.Reply, 0);
			AddLabel(55, 277, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 224 ] );
			
			// Close and get: 10
			AddButton(35, 300, 9702, 9703, 10, GumpButtonType.Reply, 0);
			AddLabel(55, 297, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 225 ] );

			// Close and delete: 11
			AddButton(35, 320, 9702, 9703, 11, GumpButtonType.Reply, 0);
			AddLabel(55, 317, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 226 ] );

			AddImageTiled(15, 345, 270, 1, 9304);

			// Exit: 0
			AddButton(15, 350, 9702, 9703, 0, GumpButtonType.Reply, 0);
			AddLabel(35, 348, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 14 ] );
		}
