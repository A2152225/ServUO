...
namespace Arya.Auction
{
	...
	public class AuctionSearchGump : Gump
	{
		...
		private void MakeGump()
		{
			...
			AddLabel(185, 45, AuctionLabelHue.kGreenHue, AuctionSystem.ST[ 32 ] );
			AddImage(420, 320, 10412);
			AddImage(0, 170, 10401);
			AddImage(420, 170, 10411);

			// TEXT 0 : Search text
			AddLabel(70, 115, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 33 ] );
			AddImageTiled(145, 135, 200, 20, 3004);
			AddImageTiled(146, 136, 198, 18, 2624);
			AddAlphaRegion(146, 136, 198, 18);
			AddTextEntry(146, 135, 198, 20, AuctionLabelHue.kRedHue, 0, @"");

			AddLabel(70, 160, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 34 ] );

			AddCheck(260, 221, 2510, 2511, false, 1);
			AddLabel(280, 220, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 35 ] );

			if ( Core.AOS )
			{
				AddCheck(260, 261, 2510, 2511, false, 9);
				AddLabel(280, 260, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 36 ] );

				AddCheck(260, 241, 2510, 2511, false, 4);
				AddLabel(280, 240, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 37 ] );
			}

			AddCheck(260, 201, 2510, 2511, false, 3);
			AddLabel(280, 200, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 38 ] );

			AddCheck(260, 181, 2510, 2511, false, 5);
			AddLabel(280, 180, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 39 ] );

			AddCheck(90, 181, 2510, 2511, false, 6);
			AddLabel(110, 180, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 40 ] );

			AddCheck(90, 201, 2510, 2511, false, 7);
			AddLabel(110, 200, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 41 ] );

			AddCheck(90, 221, 2510, 2511, false, 8);
			AddLabel(110, 220, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 42 ] );

			AddCheck(90, 241, 2510, 2511, false, 2);
			AddLabel(110, 240, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 43 ] );

			AddCheck(90, 261, 2510, 2511, false, 12);
			AddLabel(110, 260, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 44 ] );

			if ( Core.AOS )
			{
				AddCheck(90, 280, 2510, 2511, false, 11);
				AddLabel(110, 279, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 45 ] );

				AddCheck(260, 280, 2510, 2511, false, 10);
				AddLabel(280, 279, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 46 ] );
			}

			// BUTTON 1 : Search
			AddButton(255, 350, 4005, 4006, 1, GumpButtonType.Reply, 0);
			AddLabel(295, 350, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 16 ] );

			// BUTTON 0 : Cancel
			AddButton(85, 350, 4017, 4018, 0, GumpButtonType.Reply, 0);
			AddLabel(125, 350, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 47 ] );
			
			// CHECK 0: Search withing existing results
			AddCheck(80, 310, 9721, 9724, false, 0);
			AddLabel(115, 312, AuctionLabelHue.kLabelHue, AuctionSystem.ST[ 48 ] );
		}
