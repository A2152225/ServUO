...
{ 
   public class CrystalElementalIdol : Item 
   { 
      [Constructable] 
      public CrystalElementalIdol() : base( 9760 ) 
      { 
         Movable = true; 
         Name = "Crystal Elemental Idol";  
         LootType = LootType.Blessed; 
      } 

      public CrystalElementalIdol( Serial serial ) : base( serial ) 
      { 
      } 
