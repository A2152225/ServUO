...
{ 
   public class EthWarriorIdol : Item 
   { 
      [Constructable] 
      public EthWarriorIdol() : base( 9609 ) 
      { 
         Movable = true; 
         Name = "Ethereal Warrior Idol";  
         LootType = LootType.Blessed; 
      } 

      public EthWarriorIdol( Serial serial ) : base( serial ) 
      { 
      } 
