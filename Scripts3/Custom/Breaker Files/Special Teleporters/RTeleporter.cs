...
namespace Server.Items
{
	public class RTeleporter : Item
	{
		...
		{
			get{ return m_rX; }
			set{ m_rX = value; InvalidateProperties(); }
		}
	...
	[CommandProperty( AccessLevel.GameMaster )]
		...
		{
			get{ return m_rY; }
			set{ m_rY = value; InvalidateProperties(); }
		}
		...
		{
			get{ return m_rZ; }
			set{ m_rZ = value; InvalidateProperties(); }
		}
		/*[CommandProperty( AccessLevel.GameMaster )]
		...
		[Constructable]
		public RTeleporter() : this( new Point3D( 0, 0, 0 ), null, false )
		{
		Name = "Relative Teleporter";
		}

		[Constructable]
		public RTeleporter( int XX,int YY, int ZZ ) : base( 0x1BC3 ) 
		{
		rX = XX;
		rY = YY;
		rZ = ZZ;
		...
		[Constructable]
		public RTeleporter( Point3D pointDest, Map mapDest, bool creatures ) : base( 0x1BC3 )
		{
			Movable = false;
			Visible = false;
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			if ( m_rX != null )
				list.Add( 1060661, "Relative X\t{0}", m_rX );
			
			if ( m_rY != null )
				list.Add( 1060662, "Relative Y\t{0}", m_rY );				
				
			if ( m_rZ != null )
				list.Add( 1060663, "Relative Z\t{0}", m_rZ );
		...
		public virtual void DoTeleport( Mobile m )
		{
			...
			int Xy =((this.Y)+rY);
			int Xz =((this.Z)+rZ);
			Point3D R = new Point3D(Xx,Xy,Xz);
			...
			Server.Mobiles.BaseCreature.TeleportPets( m, R, map );
		...
		public RTeleporter( Serial serial ) : base( serial )
		{
		}
		...
		public override void Serialize( GenericWriter writer )
		{
			...
			writer.Write( (int) m_rX);
			writer.Write( (int) m_rY);
			writer.Write( (int) m_rZ);
	...
	public class RSkillTeleporter : Teleporter
	{
		...
		[Constructable]
		public RSkillTeleporter()
		{
		}

		public RSkillTeleporter( Serial serial ) : base( serial )
		{
		}
	...
	public class RKeywordTeleporter : Teleporter
	{
		...
		[Constructable]
		public RKeywordTeleporter()
		{
			m_Keyword = -1;
			m_Substring = null;
		}

		public RKeywordTeleporter( Serial serial ) : base( serial )
		{
		}
