...
namespace Server.Regions
{
	...
	public class GroupDungeonRegion : Region
	{
        ...
        public static void GroupWipe(object state)
        {
            ...
            {
                PlayerMobile pm = (PlayerMobile)m;
                pm.SendMessage(34,"Your group has been defeated. You, any pets, and your corpse will be telported out of the instance within {0} minutes, {1} seconds.", m_RezTimer.Minutes, m_RezTimer.Seconds);
                
              if (m_BlessCorpses) // if global flag is true, bless the corpse
				{
				if (pm.Corpse != null)  //is there a corpse?
        ...
        public static void DungeonCleared(object state)
        {
            ...
            {
                PlayerMobile pm = (PlayerMobile)m;
                pm.SendMessage(34, "Your group has conquered {0}! You will be telported out of the instance within {1} minutes, {2} seconds.", stone.DungeonName, m_KickTimer.Minutes, m_KickTimer.Seconds);
